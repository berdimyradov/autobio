...
// export const startPage = 11;
// export const delayBetweenPageFlipping = 100;
// export const crosswordAnimationSpeed = 50;
// export const projectReviewDuration = 500;
// export const projectReviewDelimiter = 70;

// DEV: For animation logic
// export const isGreetingEnabled = true;
// export const greetingDuration: number = 3;
// export const animationSpeedMode = 0.1; // from 0 to 1
// export const startPage = 0;
// export const delayBetweenPageFlipping = 200;
// export const crosswordAnimationSpeed = 150;
// export const projectReviewDuration = 600;
// export const projectReviewDelimiter = 100;
...
export const projectReviewDuration = 5750;
export const projectReviewDelimiter = 750;
